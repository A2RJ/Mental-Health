...
@section('contentJs')
	<script>
		...
		table = $('#grdData').DataTable({
			...
			columns: [
				{ data: "pasien_id", name: "pasien_id", orderable: false,
				...
				{ data: "pasien_id", name: "pasien_id", orderable: false, 
					render: function(data, type, row, meta){
						var elShow = '<a class="btn btn-sm btn-default" href="javascript: editData(\''+row.name+'\',\''+row.pasien_id+'\');"><i class="fa fa-eye"></i></a>';
