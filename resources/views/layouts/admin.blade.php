...
<head>
    ...
    <link rel="stylesheet"
        href="{{ asset('admin-lte/plugins/font-awesome/css/font-awesome.min.css', ENV('SSL_FLAG')) }}">
    ...
    <link rel="stylesheet"
        href="{{ asset('admin-lte/plugins/select2/css/select2-bootstrap.min.css', ENV('SSL_FLAG')) }}">
    <link rel="stylesheet"
        href="{{ asset('admin-lte/plugins/datepicker/css/bootstrap-datepicker3.min.css', ENV('SSL_FLAG')) }}">
    <link rel="stylesheet"
        href="{{ asset('admin-lte/plugins/datatables/datatables.net-bs/css/dataTables.bootstrap.min.css', ENV('SSL_FLAG')) }}">
    <link rel="stylesheet" href="{{ asset('admin-lte/plugins/admin-lte/css/AdminLTE.min.css', ENV('SSL_FLAG')) }}">
    <link rel="stylesheet"
        href="{{ asset('admin-lte/plugins/admin-lte/css/skins/_all-skins.min.css', ENV('SSL_FLAG')) }}">
    <link rel="stylesheet"
...
<body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
        ...
        <footer class="main-footer">
            ...
            {{ date('Y') }} &copy; Created by <strong><span><a href="http://sonyamin58.com/">Gelar Family
                        Engineer</a></span></strong>.
        </footer>
    </div>
    ...
    <script
        src="{{ asset('admin-lte/plugins/datatables/datatables.net/js/jquery.dataTables.min.js', ENV('SSL_FLAG')) }}">
    </script>
    <script
        src="{{ asset('admin-lte/plugins/datatables/datatables.net-bs/js/dataTables.bootstrap.min.js', ENV('SSL_FLAG')) }}">
    </script>
